...
namespace secrets
{
  namespace machine_data
  {
    ...
    static constexpr Machine::MachineIDType machine_id = 0x12345678; /* Machine connected to the ESP32 */
    static constexpr std::array<card::uid_t, 10> whitelist /* List of RFID tags whitelisted, regardless of connection */
    {
        0xF6F07894,
        0xAABBCCDD,
        0xAABBCCDD,
